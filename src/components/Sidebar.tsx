...
import { Film, BookOpen, MessageCircle, User, ListFilter } from "lucide-react";
...
export default function Sidebar() {
  ...
  return (
    <div className="fixed left-0 top-0 h-full bg-boovie-dark shadow-md w-[70px] md:w-[200px] flex flex-col">
      {/* Logo at the top */}
